...
if authentication_status:
    ...
    revo_types = ["REVO1", "REVO3K", "REVOSS"]
    ...
    total_revo = revo_one_number + revo_3000_number + revo_smartstop_number
    ...
    with tab6:
        ...
        col7.metric("REVO ONE", "%s%%" % round_ONE)
        col8.metric("REVO 3000", "%s%%" % round_3000)
        col9.metric("REVO SmartStop", "%s%%" % round_SS)
